...
function ContactPage() {
    ...
    // const handleChange = (e) => {
    //   const { name, value, checked } = e.target;
    //   if (name === 'isCheckedOther') {
    //     setFormData(prevData => ({
    //       ...prevData,
    //       selectedCategories: checked
    //         ? [...prevData.selectedCategories, value]
    //         : prevData.selectedCategories.filter(category => category !== value),
    //     }));
    //   } else {
    //     setFormData(prevData => ({
    //       ...prevData,
    ...
    const handleSubmit = async (e) => {
      ...
      console.log("Company Email:", formData.email);
      for(var i=0; i<formData.selectedCategories.length; i++) {
        console.log(formData.selectedCategories[i]);
        if(formData.selectedCategories[i] == 'AI'){}
      };
      for(var i=0; i<formData.additionalCategories.length; i++) {
        console.log(formData.additionalCategories[i]);
      };
        ...
        <form onSubmit={handleSubmit}>
                ...
                <div className="select-tect-categ flex flex-wrap gap-4 mt-3">
                  <div className="tect-categ-1">
                    <input 
                      ...
                      onChange={handleChange}
                    />
                    <label htmlFor="ai-option" className="bg-zinc-600 inline-flex items-center justify-between w-full py-5 px-9 text-white rounded-xl cursor-pointer peer-checked:bg-indigo-900 hover:bg-indigo-600">
                      <div className="block">
                  ...
                  <div className="tect-categ-2">
                    <input 
                      ...
                      onChange={handleChange}
                    />
                    <label htmlFor="data-analysis-option" className="bg-zinc-600 inline-flex items-center justify-between w-full py-5 px-9 text-white rounded-xl cursor-pointer peer-checked:bg-indigo-900 hover:bg-indigo-600">                           
                      <div className="block">
                  ...
                  <div className="tect-categ-3">
                    <input 
                      ...
                      onChange={handleChange}
                    />
                    <label htmlFor="full-stack-option" className="bg-zinc-600 inline-flex items-center justify-between w-full py-5 px-9 text-white rounded-xl cursor-pointer peer-checked:bg-indigo-900 hover:bg-indigo-600">                           
                      <div className="block">
                  ...
                  <div className="tect-categ-4">
                    <input 
                      ...
                      onChange={handleChange}
                    />
                    <label htmlFor="other-option" className="bg-zinc-600 inline-flex items-center justify-between w-full py-5 px-9 text-white rounded-xl cursor-pointer peer-checked:bg-indigo-900 hover:bg-indigo-600">                           
                      <div className="block">
          ...
          {step === 3 && (
            ...
            <div className='md:mx-28 mx-10'>
              ...
              <button type="submit" className="w-full mt-4 h-12 px-6 text-white transition-colors font-semibold duration-150 text-lg bg-indigo-600 rounded-md focus:shadow-outline hover:bg-indigo-800">Submit</button>
